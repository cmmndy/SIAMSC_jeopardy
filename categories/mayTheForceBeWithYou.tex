...
\begin{textarea}[]
	\only<1>{
		The force $\textbf{F}$ acting on a particle of electric charge $q$ with instantaneous velocity $\textbf{v}$, due to an external electric field $\textbf{E}$ and magnetic field $\textbf{B}$
